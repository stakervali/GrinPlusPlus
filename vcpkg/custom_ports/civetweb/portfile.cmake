...
if(VCPKG_C_FLAGS)
    set(COMBINED_C_FLAGS "${VCPKG_C_FLAGS} -D_CRT_SECURE_NO_WARNINGS")
else()
    set(COMBINED_C_FLAGS "-D_CRT_SECURE_NO_WARNINGS")
endif()

if(VCPKG_CXX_FLAGS)
    set(COMBINED_CXX_FLAGS "${VCPKG_CXX_FLAGS} -D_CRT_SECURE_NO_WARNINGS")
else()
    set(COMBINED_CXX_FLAGS "-D_CRT_SECURE_NO_WARNINGS")
endif()
